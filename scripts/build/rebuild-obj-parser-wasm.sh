...
Options:
  ...
  --source <path>       C++ source file.
                        Default: ./src/core/loaders/wasm/obj_parser.cpp
  --dest-dir <path>     Output directory.
                        Default: ./public/wasm/obj-parser
...
EMSDK_ENV=""
SOURCE_PATH="${ROOT_DIR}/src/core/loaders/wasm/obj_parser.cpp"
DEST_DIR="${ROOT_DIR}/public/wasm/obj-parser"
...
if [[ ! -f "${SOURCE_PATH}" ]]; then
  echo "Missing OBJ parser source: ${SOURCE_PATH}" >&2
  exit 1
fi
...
COMMON_FLAGS=(
  ...
  -s MODULARIZE=1
  -s EXPORT_ES6=1
  -s EXPORT_NAME=createObjParserModule
  -s ENVIRONMENT=web,worker,node
  -s FILESYSTEM=0
  -s ALLOW_MEMORY_GROWTH=1
  -s MALLOC=emmalloc
  -s EXPORTED_FUNCTIONS='["_malloc","_free","_parse_obj","_obj_parser_get_result_ptr","_obj_parser_get_result_size","_obj_parser_get_error_ptr","_obj_parser_get_error_size","_obj_parser_free_result"]'
  -s EXPORTED_RUNTIME_METHODS='["HEAPU8"]'
  -o "${DEST_DIR}/objParser.js"
)
...
echo "Built OBJ parser WASM:"
echo "  ${DEST_DIR}/objParser.js"
echo "  ${DEST_DIR}/objParser.wasm"
