  ...
  if (missing.length > 0) {
    throw new Error(
      [
        ...
        'Register each entry in scripts/regression/run_unitree_browser_regression.mjs and scripts/regression/validate_unitree_selected_browser.mjs before running full validation:',
