...
const suiteDefinitions = {
  ...
  'regression-unit': {
    description: 'Lightweight node:test files that live beside regression scripts.',
    files: () => collectTestFiles('scripts/regression'),
  },
  all: {
    ...
    files: () =>
      dedupeAndSort([
        ...
        ...collectTestFiles('scripts/regression'),
      ]),
  },
};
