 ...
 *   2. browser  — every scripts/testing/browser/test_*.mjs, auto-discovered from
 ...
 *
 * Usage:
 *   node scripts/testing/runner/run-all.mjs [options]
...
import { ensureSite, DEFAULT_SITE_URL, writeJsonAtomic } from '../../e2e/helpers/browser-helpers.mjs';
...
function buildStages(opts, scripts) {
  ...
  if (opts.unit) {
    stages.push({
      ...
      run: () => spawnSync(
        process.execPath,
        ['scripts/testing/runner/run-node-tests.mjs', opts.unitSuite],
