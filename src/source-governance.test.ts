...
const oversizedRuntimeFileLineBudgets: Record<string, number> = {
  'src/features/urdf-viewer/workers/usdOffscreenViewer.worker.ts': 2928,
  'src/features/urdf-viewer/hooks/useViewerController.ts': 2178,
  'src/shared/debug/regressionBridge.ts': 2082,
  'src/core/parsers/mjcf/mjcfParser.ts': 2005,
  'src/core/parsers/mjcf/mjcfGenerator.ts': 1905,
  'src/core/parsers/sdf/sdfParser.ts': 1786,
  ...
  'src/core/parsers/mjcf/mjcfHierarchyBuilder.ts': 1567,
  'src/app/hooks/workspaceSourceSyncUtils.ts': 1516,
  'src/features/property-editor/components/CollisionOptimizationDialog.tsx': 1488,
  ...
  'src/features/assembly/components/bridge-create/BridgeCreateModal.tsx': 1247,
  'src/features/urdf-viewer/utils/robotLoaderGeometryPatch.ts': 1235,
  'src/features/property-editor/components/LinkProperties.tsx': 1203,
  'src/app/hooks/useWorkspaceSourceSync.ts': 1179,
  'src/features/robot-tree/components/tree-editor/TreeStructureGraphDialog.tsx': 1178,
  'src/core/parsers/urdf/loader/buildRuntimeRobotFromState.ts': 1147,
