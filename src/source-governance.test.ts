...
const oversizedRuntimeFileLineBudgets: Record<string, number> = {
  ...
  'src/app/utils/importPreparation.ts': 1802,
  'src/core/parsers/sdf/sdfParser.ts': 1794,
  ...
  'src/features/urdf-viewer/hooks/useMouseInteraction.ts': 1491,
  ...
  'src/features/assembly/components/bridge-create/BridgeCreateModal.tsx': 1270,
  'src/features/property-editor/components/CollisionOptimizationPlanarGraph.tsx': 1267,
  'src/features/urdf-viewer/utils/robotLoaderGeometryPatch.ts': 1251,
  ...
  'src/app/hooks/useWorkspaceSourceSync.ts': 1180,
  'src/core/parsers/urdf/loader/buildRuntimeRobotFromState.ts': 1156,
  'src/features/urdf-viewer/components/RobotModel.tsx': 1138,
