...
const SNAPSHOT_PANEL_SELECT_CLASSNAME =
  'h-[23px] rounded-md border-border-black bg-input-bg !px-1.5 !py-0 !pr-6 !text-[10px] font-medium leading-none shadow-sm';
const SNAPSHOT_PANEL_SELECT_OPTION_CLASSNAME = 'text-[10px] leading-none';
